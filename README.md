...
The design and project structure are based on the original [Space Portfolio](https://github.com/gautam1426/space-portfolio) project by [Harshil Gautam](https://github.com/gautam1426). Retain all notices required by the upstream license when restoring or redistributing upstream source files and assets.
